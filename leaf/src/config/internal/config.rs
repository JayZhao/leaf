...
// @@protoc_insertion_point(message:HysteriaOutboundSettings)
#[derive(PartialEq,Clone,Default,Debug)]
...
impl<'a> ::std::default::Default for &'a HysteriaOutboundSettings {
    fn default() -> &'a HysteriaOutboundSettings {
        <HysteriaOutboundSettings as ::protobuf::Message>::default_instance()
    }
}

impl HysteriaOutboundSettings {
    pub fn new() -> HysteriaOutboundSettings {
        ::std::default::Default::default()
    }
}

impl ::protobuf::Message for HysteriaOutboundSettings {
    const NAME: &'static str = "HysteriaOutboundSettings";
    ...
    fn new() -> HysteriaOutboundSettings {
        HysteriaOutboundSettings::new()
    }
